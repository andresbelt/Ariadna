...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C06551 extends Animation {
    ...
    class C06562 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    /* renamed from: com.sololearn.app.views.MaterialProgressDrawable.3 */
    class C06573 implements Callback {
        C06573() {
        }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C06551(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C06562(ring));
